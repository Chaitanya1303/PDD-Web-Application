...
const appCss = "/assets/styles-C2l6I_Sa.css";
...
const $$splitComponentImporter = () => import("./index-C3HKs_7z.mjs");
const Route = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "AI-powered skin, hair, and nutrition analysis with personalized recommendations."
    }, {
      property: "og:title",
      content: "Glowtics"
    }, {
      property: "og:description",
      content: "Intelligent skin, hair & nutrition care app."
    }]
  }),
